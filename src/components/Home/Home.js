...
class Home extends Component {
    ...
    submitForm = () => {
        ...
        // axios.post('https://cryptic-garden-96376.herokuapp.com/generatePDF',this.props.data,
        // {headers:
        ...
        {
            method:'post',
            headers:{'Content-Type':'application/json',"Accept":"application/pdf","Access-Control-Allow-Origin": "*"},
            body:JSON.stringify({
